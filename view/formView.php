...
<body>
    ...
    <footer>
        <p class="copyright-agileinfo"> &copy; 2022 Todos los Derechos Reservados | Diseñado por <a href="#">Lynneth Pereira</a></p>
    </footer>
                ...
                success: function(respuesta){       //Si la respuesta es satisfactoria
                  ...
                  var data = JSON.parse(respuesta);     // Obtiene la respuesta desde el controlador obtenida del modelo y se transforma el string a Json
                   ...
                   if (data.msj === "Good") {       //Si el mensaje es igual a Good tal y como esta en el modelo, oculta los errores del formulario 
                     ...
                     Swal.fire({        //Luego muestra una alerta de sweetAlert como todo ha sido exitoso
                        position: 'bottom-end',
                        type: 'success',
                        timer: 1500,
                   ...
                   //Si la contraseña está bloqueada o el usuario y contraseña son invalidos, muestra el correspondiente mensaje
