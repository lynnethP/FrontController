<?php
	...
	define("_ROUTE_" , "/ProjectLynneth/");					/* direccion del proyecto */
	define("_THEME_" , "/ProjectLynneth/assets");			/* Direccion de recursos y estilos */
	define("_INDEX_FILE_" , "/ProjectLynneth/index.php");	/* direccion del archivo index */
	...
	define("_DB_WEB_" , "db_electiva");								/* nombre de la base de datos */
	...
	define("_COMPLEMENT_" , "/ProjectLynneth/view/assets/");					/* direccion del proyecto */
